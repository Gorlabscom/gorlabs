...
describe('<MenuBar />', () => {
  it('should render component successfully', async () => {
    ...
    const menu = screen.getByText('File');

    expect(menu).toBeInTheDocument();

    await act(() => userEvent.click(menu));
    ...
    await act(() => userEvent.hover(view));
    ...
    await act(() => userEvent.hover(profiles));

    await waitFor(() => expect(screen.getByText('Andy')).toBeInTheDocument());

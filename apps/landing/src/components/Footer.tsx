...
const Footer = () => {
  return (
    <footer className="bg-[#fcfdff] dark:bg-zinc-900 w-full py-12">
      <hr className="border-gray-800 dark:border-gray-200 w-full mx-auto my-12" />
      {/* <div className=" px-1"> */}
      <MaxWidthWrapper>
        <div className="grid lg:grid-cols-2 gap-12 items-center text-center">
          <div className="flex flex-col items-center gap-4 lg:items-start lg:text-left">
            ...
            <p className="text-sm text-gray-500 text-start text-muted-foreground dark:text-gray-400">
              Our mission is to providing best AI saas tools by making Gorlabs
              effortless, affordable, and accessible to all.
            </p>
          ...
          <div className="grid grid-cols-2 gap-8 text-sm font-medium lg:text-base">
            <div className="flex flex-col gap-1.5 lg:text-left">
              ...
              <nav className="flex flex-col gap-2">
                ...
                <Link
                  className="text-gray-300 dark:text-gray-600 pointer-events-none hover:underline"
                  href="#"
                >
                  Features
                </Link>
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between text-sm lg:text-base">
          <p className="mb-4 text-gray-500 dark:text-gray-400 lg:order-2">
            ©2024 Gorlabs. All rights reserved.
          </p>
          <div className="flex gap-4 lg:gap-8 lg:order-1">
            <Link
              className="text-gray-300 dark:text-gray-600 pointer-events-none hover:underline underline-offset-4"
              href="#"
            >
              Terms of Service
            </Link>

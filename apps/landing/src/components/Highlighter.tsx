...
function MousePositionXY(): MousePosition {
...
export const HighlightGroup: React.FC<HighlightGroupProps> = ({
  ...
  const mousePosition = MousePositionXY();

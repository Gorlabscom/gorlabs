...
import { Container, SectionBadge } from '@repo/design-system/components';
            ...
            <div className="py-12 md:py-20">
              ...
              <div className="flex flex-col items-center gap-4">
                ...
                <div className="group grid h-full gap-6 md:grid-cols-12">
                  ...
                  <div
                    className='group/item h-full rounded-xl border border-neutral-500/50 md:col-span-6 lg:col-span-12'
                    data-aos="fade-down"
                  >
                    {/* <HighlighterItem> */}
    ...
    >
      ...
      >
        <div className="hover:-translate-y-2 duration-500">
          ...
          <p className={cn('mt-8 mb-4 font-semibold text-sm tracking-tight ')}>
            This plan includes:
          </p>

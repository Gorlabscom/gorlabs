...
const cloneGorlabs = async (name: string, packageManager: string) => {
  const command = [
...
export const initialize = async (options: {
  ...
  try {
    intro("Let's start a gorlabs project!");
    ...
    s.start('Cloning gorlabs...');
    await cloneGorlabs(name, packageManager);
